...
import { P as ProtocolError, p as TimeoutWaitingForResponseErrorCode, q as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, s as lookupResultToBuffer, t as RequestStatusResponseStatus, U as UnknownError, v as RequestStatusDoneNoReplyErrorCode, w as RejectError, x as CertifiedRejectErrorCode, y as UNREACHABLE_ERROR, I as InputError, z as InvalidReadStateRequestErrorCode, B as ReadRequestType, D as Principal, F as IDL, G as MissingCanisterIdErrorCode, H as HttpAgent, J as encode, Q as QueryResponseStatus, K as UncertifiedRejectErrorCode, N as isV3ResponseBody, O as isV2ResponseBody, V as UncertifiedRejectUpdateErrorCode, W as UnexpectedErrorCode, Y as decode, Z as Subscribable, _ as pendingThenable, $ as resolveEnabled, a0 as shallowEqualObjects, a1 as resolveStaleTime, a2 as noop, a3 as environmentManager, a4 as isValidTimeout, a5 as timeUntilStale, a6 as timeoutManager, a7 as focusManager, a8 as fetchState, a9 as replaceData, aa as notifyManager, ab as hashKey, ac as getDefaultState, r as reactExports, ad as shouldThrowError, o as useQueryClient, n as useInternetIdentity, ae as createActorWithConfig, af as Record, ag as Vec, ah as Service, ai as Func, aj as Opt, ak as Nat, al as Text, am as Int, an as Bool, ao as Principal$1 } from "./index-CbYhoYbs.js";
...
const CreateContactArgs = Record({
  "name": Text,
  "email": Text,
  "message": Text
});
...
Service({
  "addProduct": Func([CreateProductArgs], [Product], []),
  ...
  "initialize": Func([], [], []),
  "submitContact": Func([CreateContactArgs], [ContactSubmission], []),
  "toggleProductActive": Func([ProductId], [Opt(Product)], []),
  "updateProduct": Func([UpdateProductArgs], [Opt(Product)], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreateContactArgs2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "message": IDL2.Text
  });
  ...
  return IDL2.Service({
    "addProduct": IDL2.Func([CreateProductArgs2], [Product2], []),
    ...
    "initialize": IDL2.Func([], [], []),
    "submitContact": IDL2.Func([CreateContactArgs2], [ContactSubmission2], []),
    "toggleProductActive": IDL2.Func([ProductId2], [IDL2.Opt(Product2)], []),
    "updateProduct": IDL2.Func([UpdateProductArgs2], [IDL2.Opt(Product2)], [])
  });
};
class Backend {
...
function useProductById(id) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["products", id == null ? void 0 : id.toString()],
    queryFn: async () => {
...
export {
  ...
  createActor as g,
  useAllProducts as h,
  useDeleteProduct as i,
  useToggleProductActive as j,
  useAddProduct as k,
